...
public class RestApiExceptionHandler {
   ...
   public ResponseEntity<Error> handleGenericException(final HttpServletRequest req,
      ...
      final Error error = ErrorUtils
              .crearError(ErrorCode.ERROR_GENERICO.getCodigo(),
   ...
   public ResponseEntity<Error> handleGenericException(final HttpServletRequest req,
      ...
      final Error error = ErrorUtils
              .crearError(ErrorCode.ENTIDAD_YA_EXISTE.getCodigo(),
                      String.format("%s, %s", ErrorCode.ENTIDAD_YA_EXISTE.getLlaveMensaje(),
                              ex.getMessage()),
   ...
   public ResponseEntity<Error> handleGenericException(final HttpServletRequest req,
      ...
      final Error error = ErrorUtils
              .crearError(ErrorCode.VIOLACION_REGLA_DE_NEGOCIO.getCodigo(), ex.formatException(),
   ...
   public ResponseEntity<Error> handleGenericException(final HttpServletRequest req,
      ...
      final Error error = ErrorUtils
              .crearError(ErrorCode.ENTIDAD_NO_ENCONTRADA.getCodigo(),
                      String.format("%s, %s",
